	...
	<view class="tui-waterfall__box"
		...
		<view class="tui-waterfall__list" id="tui-waterfall__left" :style="{ marginRight: columnGap }">
			<view v-for="(item, index) in leftList" :key="index">
				<slot name="left" :entity="item" :params="params" :index="index" :isList="columnCount==1"></slot>
			</view>
		</view>
		<view v-if="columnCount > 1" class="tui-waterfall__list" id="tui-waterfall__right">
			<view v-for="(item, index) in rightList" :key="index">
				<slot name="right" :entity="item" :params="params" :index="index" :isList="columnCount==1"></slot>
			</view>
		</view>
	</view>
</template>
