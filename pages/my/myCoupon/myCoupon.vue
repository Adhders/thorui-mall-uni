		...
		<view class="tui-coupon-list" :class="{'tui-mtop':scrollTop>=0}">
			<view v-for="(item,i) in couponList" :key="i" v-show="currentTab==i">
				<view class="tui-coupon-item tui-top20" v-for="(coupon,j) in item.data" :key="j">
					<image :src="webURL+'https://system.chuangbiying.com/static/images/mall/coupon/bg_coupon_3x.png'" class="tui-coupon-bg" mode="widthFix"></image>
	...
	export default {
		...
		methods: {
			getSignUrl: function(index) {
				let url = "";
				if (index == 1) {
					url = "https://system.chuangbiying.com/static/images/mall/coupon/img_coupon_beused_3x.png"
				} else if (index == 2) {
					url = "https://system.chuangbiying.com/static/images/mall/coupon/img_coupon_failure_3x.png"
				}
				return url
			},
			change(e) {
