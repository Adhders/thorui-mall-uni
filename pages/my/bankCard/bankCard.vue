	...
	<view class="container">
		...
		<view class="tui-bankcard__list">
			...
			<view class="tui-bankcard__item tui-min_sheng">
				<view class="tui-card__info">
					<view class="tui-logo__box">
						<image class="tui-logo" src="https://system.chuangbiying.com/static/images/mall/bank/m_s.png"></image>
					</view>
					<view class="tui-name__box">
			...
			<view class="tui-bankcard__item tui-nong_ye">
				<view class="tui-card__info">
					<view class="tui-logo__box">
						<image class="tui-logo" src="https://system.chuangbiying.com/static/images/mall/bank/n_y.png"></image>
					</view>
					<view class="tui-name__box">
			...
			<view class="tui-bankcard__item tui-zhong_xin">
				<view class="tui-card__info">
					<view class="tui-logo__box">
						<image class="tui-logo" src="https://system.chuangbiying.com/static/images/mall/bank/z_x.png"></image>
					</view>
					<view class="tui-name__box">
			...
			<view class="tui-bankcard__item tui-zhao_shang">
				<view class="tui-card__info">
					<view class="tui-logo__box">
						<image class="tui-logo" src="https://system.chuangbiying.com/static/images/mall/bank/z_s.png"></image>
					</view>
					<view class="tui-name__box">
			...
			<view class="tui-bankcard__item tui-jian_she">
				<view class="tui-card__info">
					<view class="tui-logo__box">
						<image class="tui-logo" src="https://system.chuangbiying.com/static/images/mall/bank/j_s.png"></image>
					</view>
					<view class="tui-name__box">
