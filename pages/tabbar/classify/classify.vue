					...
					<view class="class-box">
						<view class="class-item">
							...
							<view class="g-container">
								...
								海来阿木 	<image src="https://system.chuangbiying.com/static/images/product/11.jpg" class="g-image" />
						...
						<view class="class-item">
							...
							<view class="g-container">
								...
								<view class="g-box" @tap.stop="productList" data-key="抽纸">
									<image src="https://system.chuangbiying.com/static/images/product/55.jpg" class="g-image" />
